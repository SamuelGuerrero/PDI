  ...
  return (
    <div>
      <Input
        idInput="imagen1"
        selectTool={() =>
          SegmentacionAlgoritm(setRgbPixel, 100, setPixelSelected)
        }
      />
      <div
      ...
      />
      <div className="container my-auto flex flex-col items-center space-y-5 mx-auto">
